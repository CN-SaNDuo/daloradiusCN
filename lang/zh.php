...
$l['all']['CleanupSessions'] = "清理过期的账单，直到日期：";
...
$l['all']['TxnId'] = "交易ID";
$l['all']['PlanActive'] = "活动计费";
$l['all']['PlanTimeType'] = "计费时间类型";
$l['all']['PlanTimeBank'] = "计费时间银行";
$l['all']['PlanTimeRefillCost'] = "计费补充花费";
$l['all']['PlanTrafficRefillCost'] = "计费补充花费";
$l['all']['PlanBandwidthUp'] = "计费上传带宽";
$l['all']['PlanBandwidthDown'] = "计费下载带宽";
$l['all']['PlanTrafficTotal'] = "计费总流量";
$l['all']['PlanTrafficDown'] = "计费下载流量";
$l['all']['PlanTrafficUp'] = "计费上传流量";
$l['all']['PlanRecurring'] = "计费循环";
$l['all']['PlanRecurringPeriod'] = "计费循环周期";
$l['all']['planRecurringBillingSchedule'] = "计费重复记账安排";
$l['all']['PlanCost'] = "计费花费";
$l['all']['PlanSetupCost'] = "计费安装花费";
$l['all']['PlanTax'] = "计费税额";
$l['all']['PlanCurrency'] = "计费货币";
$l['all']['PlanGroup'] = "计费个人用户配置（组）";
$l['all']['PlanType'] = "计费类型";
$l['all']['PlanName'] = "计费名称";
$l['all']['PlanId'] = "计费ID";
...
$l['Tooltip']['planTooltip'] = "选一个计费来关联用户";
...
$l['Tooltip']['BillingPlanName'] = "记账计费名称类型";
$l['Tooltip']['PlanName'] = "计费名称类型";
...
$l['Tooltip']['planNameTooltip'] = "计费的名字。这是<br/>
					一个友好的描述计费的特性。";
$l['Tooltip']['planIdTooltip'] = "计费ID提示工具";
$l['Tooltip']['planTimeTypeTooltip'] = "计费时间类型提示工具";
$l['Tooltip']['planTimeBankTooltip'] = "计费时间银行提示工具";
$l['Tooltip']['planTimeRefillCostTooltip'] = "计费时间补充话费提示工具";
$l['Tooltip']['planTrafficRefillCostTooltip'] = "计费流量补充提示工具";
$l['Tooltip']['planBandwidthUpTooltip'] = "计费上传带宽提示工具";
$l['Tooltip']['planBandwidthDownTooltip'] = "计费下载带宽提示工具";
$l['Tooltip']['planTrafficTotalTooltip'] = "计费总流量提示工具";
$l['Tooltip']['planTrafficDownTooltip'] = "计费下载流量提示工具";
$l['Tooltip']['planTrafficUpTooltip'] = "计费流量上传提示工具";

$l['Tooltip']['planRecurringTooltip'] = "计费循环提示工具";
$l['Tooltip']['planRecurringBillingScheduleTooltip'] = "计费循环记账安排提示工具";
$l['Tooltip']['planRecurringPeriodTooltip'] = "计费循环周期提示工具";
$l['Tooltip']['planCostTooltip'] = "计费花费提示工具";
$l['Tooltip']['planSetupCostTooltip'] = "计费安装话费提示工具";
$l['Tooltip']['planTaxTooltip'] = "计费税额提示工具";
$l['Tooltip']['planCurrencyTooltip'] = "计费货币提示工具";
$l['Tooltip']['planGroupTooltip'] = "计费群组提示工具";
...
$l['Tooltip']['reassignplanprofiles'] = "如果开启,当应用用户信息 <br/>
					这个个人配置文件中列出的个人配置文件选项卡将被忽略和<br/>
					个人配置文件将被重新分配根据计费个人配置文件关联";
...
$l['button']['ListRates'] = "列出率列";
$l['button']['NewRate'] = "新的率列";
$l['button']['EditRate'] = "编辑率列";
$l['button']['RemoveRate'] = "移除率列";

$l['button']['ListPlans'] = "列出计费";
$l['button']['NewPlan'] = "新的计费";
$l['button']['EditPlan'] = "编辑计费";
$l['button']['RemovePlan'] = "移除计费";

$l['button']['ListInvoices'] = "列出账单";
$l['button']['NewInvoice'] = "新的账单";
$l['button']['EditInvoice'] = "编辑账单";
$l['button']['RemoveInvoice'] = "移除账单";

$l['button']['ListRealms'] = "列出域";
$l['button']['NewRealm'] = "新的域";
$l['button']['EditRealm'] = "编辑域";
$l['button']['RemoveRealm'] = "移除域";

$l['button']['ListProxys'] = "列出代理";
$l['button']['NewProxy'] = "新的代理";
$l['button']['EditProxy'] = "编辑代理";
$l['button']['RemoveProxy'] = "移除代理";

$l['button']['ListAttributesforVendor'] = "列表设备属性";
$l['button']['NewVendorAttribute'] = "新的设备属性";
$l['button']['EditVendorAttribute'] = "编辑设备属性";
$l['button']['SearchVendorAttribute'] = "搜索属性";
$l['button']['RemoveVendorAttribute'] = "移除设备属性";
$l['button']['ImportVendorDictionary'] = "导入设备字典";
...
$l['button']['ReAssignPlanProfiles'] = "重新分配计费个人配置文件";
...
$l['Intro']['mngradattributesnew.php'] = "新的设备属性";
...
$l['Intro']['billratesnew.php'] = "新的利率列表";
...
$l['Intro']['billinvoicelist.php'] = "列出账单";
$l['Intro']['billinvoicereport.php'] = "账单报告";
$l['Intro']['billinvoicenew.php'] = "新的账单";

$l['Intro']['billplans.php'] = "记账计费页面";
$l['Intro']['billplansdel.php'] = "删除计费条目";
$l['Intro']['billplansedit.php'] = "编辑计费明细";
$l['Intro']['billplanslist.php'] = "计费表";
$l['Intro']['billplansnew.php'] = "新的计费条目";

$l['Intro']['billpos.php'] = "销售页面的记账点";
$l['Intro']['billposdel.php'] = "删除用户";
$l['Intro']['billposedit.php'] = "编辑用户";
$l['Intro']['billposlist.php'] = "列出用户";
$l['Intro']['billposnew.php'] = "新的用户";
...
$l['Intro']['mngnew.php'] = "新的用户";
$l['Intro']['mngnewquick.php'] = "快速添加用户";
$l['Intro']['mngsearch.php'] = "搜索用户";

$l['Intro']['mnghsdel.php'] = "移除热点";
$l['Intro']['mnghsedit.php'] = "编辑热点明细";
$l['Intro']['mnghslist.php'] = "列出热点";
$l['Intro']['mnghsnew.php'] = "新的热点";

$l['Intro']['mngradusergroupdel.php'] = "移除用户组";
$l['Intro']['mngradusergroup.php'] = "用户组配置";
$l['Intro']['mngradusergroupnew.php'] = "新的用户组";
$l['Intro']['mngradusergrouplist'] = "用户组";
$l['Intro']['mngradusergrouplistuser'] = "组列表中的用户";
$l['Intro']['mngradusergroupedit'] = "编辑用户组";

$l['Intro']['mngradippool.php'] = "IP地址池配置";
$l['Intro']['mngradippoolnew.php'] = "新的IP地址池";
$l['Intro']['mngradippoollist.php'] = "列出IP地址池";
$l['Intro']['mngradippooledit.php'] = "编辑IP地址池";
$l['Intro']['mngradippooldel.php'] = "移除IP地址池";

$l['Intro']['mngradnas.php'] = "NAS配置";
$l['Intro']['mngradnasnew.php'] = "新的NAS记录";
...
$l['Intro']['mngradhuntnew.php'] = "新的寻线群记录";
...
$l['Intro']['mngradprofileslist.php'] = "列出组配置";
$l['Intro']['mngradprofilesnew.php'] = "新的组配置";

$l['Intro']['mngradgroups.php'] = "配置组";

$l['Intro']['mngradgroupreplynew.php'] = "新的组回复绘图";
...
$l['Intro']['mngradgroupchecknew.php'] = "新的组检查绘图";
...
$l['Intro']['configoperatorsnew.php'] = "新的操作人";
$l['Intro']['configoperatorslist.php'] = "操作人列表";

$l['Intro']['login.php'] = "登录";

$l['captions']['providebillratetodel'] = "提供你想去除的价格类型条目";
$l['captions']['detailsofnewrate'] = "可以填充下面新的价格的明细";
$l['captions']['filldetailsofnewrate'] = "填充下面新的价格条目的明细";
...
$l['helpPage']['repnewusers'] = "下拉表列出了每个月创建的新用户.";

$l['helpPage']['login'] = "";

$l['helpPage']['billpaypaltransactions'] = "列出所有支付宝交易";
$l['helpPage']['billhistoryquery'] = "列出所有用户计费历史(年代)";
...
<h200><b>新的配置文件 </b></h200> - Add a Profile <br/>
...
<h200><b>复制档案 </b></h200> - 复制一个概要文件的属性设置为一个新的不同的配置文件名称 <br/>
";
$l['helpPage']['mngradprofileslist'] = "
<h200><b>配置文件列表 </b></h200> - 配置文件列表 <br/>
";
$l['helpPage']['mngradprofilesnew'] = "
<h200><b>新的配置文件</b></h200> - 添加一个配置文件 <br/>
";

$l['helpPage']['mngradgroups'] = "
<b>组织管理</b> - 管理组织回复和组织检查映射(radgroupreply/radgroupcheck tables).<br/>
<h200><b>回复/查看列表组 </b></h200> - 回复/查看映射表组<br/>
<h200><b>搜索组回复/查看 </b></h200> - 搜索一组回复/查看映射(你可以使用通配符) <br/>
<h200><b>新组回复/查看 </b></h200> - 添加一组回复/检查映射 <br/>
...
<h200><b>新建IP地址池/b></h200> - 添加一个新的IP地址配置IP地址池 <br/>
...
$l['helpPage']['mngradippoolnew'] = "<h200><b>新建IP地址池</b></h200> - 添加一个新的IP地址配置IP地址池 <br/>";
...
文档这一点。此外，它需要知道在NAS端口POD或AOC数据包，而较新的NAS的使用端口3799
...
$l['helpPage']['configoperatorsnew'] = "你可以填写下面的一个新的设备的用户除了数据库的详细信息";
$l['helpPage']['configoperatorslist'] = "列出所有设备的数据库";
...
$l['helpPage']['rephistory'] = "列出所有活动执行管理项目和提供信息<br/>
创建日期,创建和更新日期和更新历史领域";
$l['helpPage']['replastconnect'] = "列出所有RADIUS服务器的登录尝试,成功和失败的登录";
...
$l['helpPage']['reptopusers'] = "下面列出记录为高级用户,那些获得了最高消费的会话
时间和带宽使用情况。清单的用户类别: ";
...
$l['helpPage']['gismain'] = "
<b> 一般信息 </b>
GIS热点位置的映射提供了可视化映射世界各地的地图使用Google Maps API。< br / >
在管理页面你可以向数据库添加新的热点条目,那里也是一个字段
...
$l['menu']['Batch Users'] = "批量用户";
$l['menu']['Profiles'] = "个人配置";
$l['menu']['User-Groups'] = "用户组";
$l['menu']['Nas'] = "<em>N</em>as";
$l['menu']['Hotspots'] = "热点";
$l['menu']['Batch Users'] = "批量用户";
$l['menu']['Users'] = "用户";
$l['menu']['HuntGroups'] = "连选群组";
$l['menu']['User-Groups'] = "用户组";
$l['menu']['Attributes'] = "属性";
$l['menu']['Realms/Proxys'] = "域/代理";
...
$l['menu']['Custom'] = "客户";
$l['menu']['Hotspot'] = "热点";
$l['menu']['Maintenance'] = "维护";
$l['menu']['General'] = "常规";
$l['menu']['Reporting'] = "报告";
$l['menu']['Maintenance'] = "维护";
$l['menu']['Operators'] = "操作人";
$l['menu']['Backup'] = "备份";
$l['menu']['POS'] = "<em>P</em>OS";
$l['menu']['Plans'] = "计费";
$l['menu']['Rates'] = "价格";
$l['menu']['Merchant-Transactions'] = "商家交易";
$l['menu']['Billing-History'] = "记账历史";
$l['menu']['Invoices'] = "发票";
$l['menu']['Payments'] = "支付";
...
$l['menu']['Heartbeat'] = "心跳";
$l['menu']['Dashboard'] = "仪表盘";
$l['menu']['Plan Accounting'] = "计费账单";
$l['menu']['Select Plan'] = "选择计费";
...
$l['menu']['Plans Management'] = "计费管理";
$l['menu']['Track Rates'] = "追踪价格";
$l['menu']['Choose Rate'] = "选择价格";
$l['menu']['Rates Management'] = "价格管理";
$l['menu']['Track PayPal Transactions'] = "跟踪PayPal交易";
$l['menu']['Rates Management'] = "价格管理";
$l['menu']['Track Billing History'] = "记账历史";
$l['menu']['Invoice Management'] = "账单管理";
$l['menu']['Select Invoice Status'] = "选择账单状态";
$l['menu']['Invoice Report'] = "账单报告";
$l['menu']['All Invoice Types'] = "所有账单类型";
...
/* ************************************二级菜单 ********************************************* 
*****  这个是2015/06/13-14:50 修改
*****   
*****  修改了主菜单的二级菜单  Home  Management  Reports  Accounting  Billing  GIS  Graphs  Config  Help
******************************************************************************************/
/*Home*/

/*Management*/
$l ['Secondary menu']['Users'] = '用户管理';
$l ['Secondary menu']['Batch Users adding'] = '批量添加用户';
$l ['Secondary menu']['Hotspots Management'] = '热点管理';
$l ['Secondary menu']['Nas'] = 'NAS管理';
$l ['Secondary menu']['User-Groups'] = '用户组管理';
$l ['Secondary menu']['Profiles'] = '配置文件管理';
$l ['Secondary menu']['HuntGroups'] = '连选群组';
$l ['Secondary menu']['Attributes'] = '设备属性管理';
$l ['Secondary menu']['Realms/Proxys'] = '领域/代理';
$l ['Secondary menu']['IP-Pool'] = 'IP地址池管理';


/*Reports*/
$l ['Secondary menu']['General'] = '综合状况';
$l ['Secondary menu']['Logs'] = '日志';
$l ['Secondary menu']['Status'] = '状态';
$l ['Secondary menu']['Batch Users'] = '新增记录';
$l ['Secondary menu']['Dashboard'] = '显示板';

/*Accounting*/
$l ['Secondary menu']['General'] = '综合状况';
$l ['Secondary menu']['Plans'] = '使用计费';
$l ['Secondary menu']['Custom'] = '自定义查询';
$l ['Secondary menu']['Hotspots'] = '热点计费';
$l ['Secondary menu']['Maintenance-Delete'] = '删除过期账单';
 /*Billing*/
 $l ['Secondary menu']['POS'] = 'POS销售终端';
 $l ['Secondary menu']['Plans'] = '使用计费';
 $l ['Secondary menu']['Rates'] = '价格';
 $l ['Secondary menu']['Merchant-Transactions'] = '商户交易';
 $l ['Secondary menu']['Billing-History'] = '帐单历史';
 $l ['Secondary menu']['Invoices'] = '发票';
 $l ['Secondary menu']['Payments'] = '支付';
/*GIS*/
...
/*Config*/
$l ['Secondary menu']['General'] = '综合状况';
$l ['Secondary menu']['Reporting'] = '报表';
$l ['Secondary menu']['Maintenance'] = '维护';
$l ['Secondary menu']['Operators'] = '操作员';
$l ['Secondary menu']['Backup'] = '备份数据';

/*Help*/ 

/*Location*/
$l ['Operator information top']['Location'] = '位置';
$l ['Operator information top']['Salutatory'] = '欢迎你！';
$l ['Operator information top']['Logout'] = '注销';

$l ['Server Status']['Uptime' ] = '运行时间';
$l ['Server Status']['System Load'] = '系统负载';
$l ['Server Status']['Hostname'] = '主机名';
$l ['Server Status']['Current Date'] = '当前日期';
$l ['Server Status']['Mem. Total'] = '物理内存';
$l ['Server Status']['Mem. Free'] = '内存空闲';
$l ['Server Status']['Mem. Used'] = '内存已用';
$l ['Server Status']['Free Drive Space'] = '可用驱动器空间';


/*******************************下拉菜单选项*****************************************/
/*mng-new-quick.php*/
$l ['option']['calculate time'] = '选择时间';
$l ['option']['seconds'] = '秒钟';		 //秒  mng-new-quick.php
$l ['option']['minutes'] = '分钟';  	 //分
$l ['option']['hours'] = '小时';		 //小时
$l ['option']['days'] = '天';			 //天
$l ['option']['weeks'] = '周';			 //周
$l ['option']['months'] = '月(30 天)';	 //月
